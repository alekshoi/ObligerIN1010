class MilitaerResept extends HvitResept {
    MilitaerResept(Legemiddel legemiddel, Lege utskrivendeLege, int pasientId) { // gjør reit til 0 og dermed er resepten ubrukelig hvis den ikk er skrevet av en lege
